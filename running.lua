...
-----
    ...
    if ism1 then  --cambio de colliders mapa
      xc = 1900
     ...
     -- cl3.pr5:setPosition(xc + mp3cl.pr5.x, xc + mp3cl.pr5.y)
     ...
     -- cl3.pr10:setPosition(xc + mp3cl.pr10.x, xc + mp3cl.pr10.y)
     -- cl3.pr11:setPosition(xc + mp3cl.pr11.x, xc + mp3cl.pr11.y)
...
if ism2 then
 ...
 --   cl3.pr10:setPosition(mp3cl.pr10.x, mp3cl.pr10.y)
  --  cl3.pr11:setPosition(mp3cl.pr11.x, mp3cl.pr11.y)
  end
